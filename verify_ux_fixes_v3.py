...
def verify_ux_fixes():
    ...
    try:
        with sync_playwright() as p:
            ...
            # 3. Open Logic category to trigger flyout
            print("Opening 'Logic' category...")
            # Blockly categories usually have class 'blocklyTreeLabel'
            page.click("text=Logic")
            time.sleep(1)
            ...
            print("Opening 'Logic' category again...")
            page.click("text=Logic")
            time.sleep(1)
            if overlay.is_visible():
                print("Clicking overlay...")
                # Click near the edge to hit the overlay
